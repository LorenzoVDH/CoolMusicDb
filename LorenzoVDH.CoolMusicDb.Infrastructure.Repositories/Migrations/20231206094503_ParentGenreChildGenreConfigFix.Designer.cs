...
namespace LorenzoVDH.CoolMusicDb.Infrastructure.Repositories.Migrations
{
    ...
    [Migration("20231206094503_ParentGenreChildGenreConfigFix")]
    partial class ParentGenreChildGenreConfigFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArtistGenre", b =>
                {
                    ...
                    b.Property<int>("PopularArtistsId")
                        .HasColumnType("integer");

                    b.HasKey("GenreId", "PopularArtistsId");

                    b.HasIndex("PopularArtistsId");

                    b.ToTable("GenrePopularArtists", (string)null);
                });
            ...
            modelBuilder.Entity("GenreGenre", b =>
                {
                    ...
                    b.ToTable("GenreGenre", (string)null);
                });
            ...
            modelBuilder.Entity("ArtistGenre", b =>
                {
                    ...
                    b.HasOne("LorenzoVDH.CoolMusicDb.ApplicationCore.Entities.Artist", null)
                        .WithMany()
                        .HasForeignKey("PopularArtistsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
